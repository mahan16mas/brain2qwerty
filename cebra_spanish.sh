...
python -m brain2qwerty_v1.start_cebra --out_dir SpanishBCBL-small-cebra-default-CebUnfold_True-wNoise_1.2_0.6 --bidir --cebra_unfolder --gru --offset 4 --batchSize 64  --random_offset --hidden 1024 --dropout 0.4 --layers 5 --nBatch 10000 --kernel 25 --stride 4 --seed 5 --do_wandb --gradClipValue 10.0 --whiteNoiseSD 1.2 --constantOffsetSD 0.6 

python -m brain2qwerty_v1.start_cebra --out_dir SpanishBCBL-small-cebra-default-CebUnfold_True-wNoise_0.5_0.2 --bidir --cebra_unfolder --gru --offset 4 --batchSize 64  --random_offset --hidden 1024 --dropout 0.4 --layers 5 --nBatch 10000 --kernel 25 --stride 4 --seed 5 --do_wandb --gradClipValue 10.0 --whiteNoiseSD 0.5 --constantOffsetSD 0.2 

python -m brain2qwerty_v1.start_cebra --out_dir SpanishBCBL-small-cebra-default-CebUnfold_True-wNoise_0.5_0.0 --bidir --cebra_unfolder --gru --offset 4 --batchSize 64  --random_offset --hidden 1024 --dropout 0.4 --layers 5 --nBatch 10000 --kernel 25 --stride 4 --seed 5 --do_wandb --gradClipValue 10.0 --whiteNoiseSD 0.5 --constantOffsetSD 0.0
...
CUDA_VISIBLE_DEVICES=1 python start_trainer.py --cebra_rnn --out_dir "nlp21_meta_CEBRARNN(h-1024_o-1024_reflect_rnn-dim-1024_rnn-layers-5_bidir)-mahanLR" --dataset_path /mnt/data/hossein/Hossein_workspace/nips_cetra/mahan/CORP/CORP_data_release --batch_size 16 --epochs 50 --conv_dropout 0.5 --dropout_input 0.2 --do_wandb --cebra_model_name Offset5Model --cebra_hidden_dim 1024 --cebra_out_dim 1024 --cebra_pad_mode replicate --rnn_hidden 1024 --rnn_layers 5 --bidir

...
python start_trainer.py --out_dir "nlp21_meta_default_50_chunk25(no overlap)" --dataset_path /data/hossein/mm_project/CORP_data_release --batch_size 16 --epochs 50 --conv_dropout 0.5 --dropout_input 0.2 --do_wandb
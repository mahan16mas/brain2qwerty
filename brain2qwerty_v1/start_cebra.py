...
parser.add_argument('--ode_mode', type=str, default='None', choices=['None', 'spatial', 'after cebra'])
parser.add_argument('--inner_root_dir', type=str, )
parser.add_argument('--inner', type=str, default='None', choices=['None', 't12', 't15', 't16'])
parser.add_argument('--dataset', type=str, choices=['speech25', 'speech45', 'nlp10', 'nlp21', 'jude_speech', 'inner', 'brain_to_voice'])
...
parser.add_argument('--initial_layer_size', type=int, default=0)
...
parser.add_argument('--gradClipValue', type=float, default=5.0)

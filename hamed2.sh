...
CUDA_VISIBLE_DEVICES=0 python start_trainer.py --out_dir "nlp21_meta-ShallowCNN(d=2,512)-Tran(1,1)_50_bs8_chunk25.4" --dataset_path /mnt/data/hossein/Hossein_workspace/nips_cetra/mahan/CORP/CORP_data_release --batch_size 8 --epochs 50 --conv_dropout 0.5 --dropout_input 0.2 --do_wandb --cnn_hidden 512 --transformer_depth 1 --transformer_head 1 --chunk_size 25 --chunk_stride 4 --cnn_depth 2 

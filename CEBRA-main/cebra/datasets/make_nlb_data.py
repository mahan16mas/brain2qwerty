...
parser.add_argument("--datapath", type=str, default="/mnt/data/hossein/Hossein_workspace/nips_cetra/Robust Decoding Project/data")
parser.add_argument("--dataset_name", type=str,  default="dmfc_rsg")
parser.add_argument("--savepath",
                    type=str,
                    default="/mnt/data/hossein/Hossein_workspace/nips_cetra/Robust Decoding Project/data/nlb")
